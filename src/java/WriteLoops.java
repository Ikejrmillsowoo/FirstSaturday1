...
public class WriteLoops {
    ...
    public int oneToFive() {
        ...
        // Write a FOR loop that counts from 1 to 5. (fixed by isaac)
            // calling
        for (int i = 1; i <= 5; i++){
            w = w + 1;
        }
    ...
    public boolean checkGameScore() {// ISAAC CHANGED THIS TO RETURN A BOOLEAN!
        int w = 0;
    ...
    public int manageYardAndJunior() {
        ...
        sendJuniorBackToSchool("it always time for school JR");
        // be sure to call
    ...
    public int tallyVote1() {
        ...
        for (int vote = 0; vote < numberOfVotes; vote++) {
